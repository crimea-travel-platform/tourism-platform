...
платформы. После создания приватного удалённого репозитория он подключается
в `tourism-platform/workspace/tourism-mobile` как Git submodule.
...
- [ ] Создать Flutter project и feature-first boundaries.
- [ ] Зафиксировать навигацию, управление состоянием и дизайн-систему.
...
- [ ] Подключить repository в `tourism-platform/workspace/tourism-mobile`.
